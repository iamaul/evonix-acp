...
const StatsState = (props) => {
    ...
    const getCountServerCharacters = async () => {
        try {
            const res = await api.get('server/stats/characters');
    ...
    const getCountServerGroupByAssistances = async () => {
        try {
            const res = await api.get('server/stats/assistances/admin');
    ...
    const getCountServerAssistances = async () => {
        try {
            const res = await api.get('server/stats/assistances');
    ...
    const getCountServerGroupByReports = async () => {
        try {
            const res = await api.get('server/stats/reports/admin');
    ...
    const getCountServerReports = async () => {
        try {
            const res = await api.get('server/stats/reports');
