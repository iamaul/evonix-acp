            ...
            >
                <List.Item>
                    ...
                    <List.Content>
                        ...
                        {created_at && (
                            <small>
                                Created at <Moment unix format="llll">{created_at}</Moment>{quizTypeCreatedBy && quizTypeCreatedBy.name && (
                                    <> by <b>{quizTypeCreatedBy.name}</b><br/></>
                                )}
                            </small>
                        )}
                        {updated_at && updated_at > 0 && (
                            <small>
                                Updated at <Moment unix format="llll">{updated_at && updated_at > 0}</Moment>{quizTypeUpdatedBy && quizTypeUpdatedBy.name && (
